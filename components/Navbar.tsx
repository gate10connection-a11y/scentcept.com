  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", height: "44px", borderBottom: border }}>
        ...
        <div style={{ flex: 1, display: "flex", justifyContent: "center", alignItems: "center", height: "100%", borderLeft: border, borderRight: border, minWidth: 0, overflow: "hidden" }}>
          {!isHome && (
            <Link href="/" className="text-[9px] md:text-[11px] tracking-[0.04em] md:tracking-[0.12em]" style={{ fontWeight: 600, color: "#000", textDecoration: "none", whiteSpace: "nowrap" }}>
              SCENTCEPT
            </Link>
          )}
        </div>
