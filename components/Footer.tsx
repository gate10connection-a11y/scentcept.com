...
export default function Footer() {
  ...
  return (
    <footer style={{ borderTop: "var(--border)" }}>
      {/* Top section — 4 column grid with cell borders, Acne Studios style */}
      <div className="grid grid-cols-2 md:grid-cols-4">
        {/* Customer Service */}
        <div className="p-6 md:p-8" style={{ borderRight: "var(--border)", borderBottom: "var(--border)" }}>
        ...
        {/* Company */}
        <div className="p-6 md:p-8" style={{ borderRight: "none", borderBottom: "var(--border)" }}>
        ...
        {/* Newsletter */}
        <div className="p-6 md:p-8" style={{ borderBottom: "var(--border)" }}>
          ...
          <div className="flex border-b border-black pb-1">
            ...
            />
            <button
              className="text-[11px] py-1 pl-3 hover:opacity-40 transition-opacity duration-200"
